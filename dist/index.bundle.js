...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _scss_main_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../scss/main.scss */ \"./Src/scss/main.scss\");\n/* harmony import */ var _scss_main_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_scss_main_scss__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _firebaseConfig_config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../firebaseConfig/config */ \"./Src/javascript/firebaseConfig/config.js\");\n/* harmony import */ var _mainTodo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./mainTodo */ \"./Src/javascript/Modules/mainTodo.js\");\n\n\n\nwindow.addEventListener(\"load\", function () {\n  new _mainTodo__WEBPACK_IMPORTED_MODULE_2__[\"MainTodo\"](_firebaseConfig_config__WEBPACK_IMPORTED_MODULE_1__[\"firebaseConfig\"]);\n});\n\n//# sourceURL=webpack:///./Src/javascript/Modules/index.js?");

/***/ }),

/***/ "./Src/javascript/Modules/mainTodo.js":
/*!********************************************!*\
  !*** ./Src/javascript/Modules/mainTodo.js ***!
  \********************************************/
/*! exports provided: MainTodo */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"MainTodo\", function() { return MainTodo; });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar MainTodo = /*#__PURE__*/function () {\n  function MainTodo(config) {\n    _classCallCheck(this, MainTodo);\n\n    //! Select Elements\n    //Buttons\n    this.showInputsButton = document.getElementById(\"detail-todo\");\n    this.addTodoButton = document.getElementById(\"add-todo\");\n    this.updateTodoButton = document.getElementById(\"update-todo\");\n    this.logoutButton = document.getElementById(\"logout-button\"); // UI Elements\n\n    this.todoDetails = document.querySelector(\".todo-center\");\n    this.todoBottom = document.querySelector(\".todo-bottom\");\n    this.navbarEmail = document.getElementById(\"navbar-email\"); // Inputs and Selects\n\n    this.selectAction = document.getElementById(\"select-action\");\n    this.selectDate = document.getElementById(\"select-date\");\n    this.inputTitle = document.getElementById(\"todo-title\");\n    this.inputDescription = document.getElementById(\"todo-description\"); //Firebase \n\n    this.config = firebase.initializeApp(config);\n    this.currentUser = \"\"; // Function to Run First\n\n    this.init();\n  }\n\n  _createClass(MainTodo, [{\n    key: \"init\",\n    value: function init() {\n      this.showInputs();\n      this.checkUserLogin();\n    }\n  }, {\n    key: \"animateCSS\",\n    value: function animateCSS(element, animation) {\n      var prefix = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'animate__';\n      var animationName = \"\".concat(prefix).concat(animation);\n      element.classList.add(\"\".concat(prefix, \"animated\"), animationName);\n\n      function handleAnimationEnd() {\n        element.classList.remove(\"\".concat(prefix, \"animated\"), animationName);\n        element.removeEventListener('animationend', handleAnimationEnd);\n      }\n\n      element.addEventListener('animationend', handleAnimationEnd);\n    }\n  }, {\n    key: \"showAlerts\",\n    value: function showAlerts(type, message) {\n      var alertDiv = document.querySelector(\".alert\");\n      var span = document.createElement(\"span\");\n      span.className = \"bg-\".concat(type);\n      span.innerText = message;\n      alertDiv.appendChild(span);\n      alertDiv.classList.remove(\"show\");\n      setTimeout(function () {\n        alertDiv.classList.add(\"show\");\n        alertDiv.innerHTML = \"\";\n      }, 1700);\n    } // UI Functions\n\n  }, {\n    key: \"showInputs\",\n    value: function showInputs() {\n      var _this = this;\n\n      this.showInputsButton.addEventListener(\"click\", function () {\n        _this.todoDetails.classList.toggle(\"active\");\n\n        _this.showInputsButton.classList.toggle(\"clicked\");\n\n        _this.animateCSS(_this.todoDetails, 'backInRight');\n      });\n    }\n  }, {\n    key: \"addTodoToUI\",\n    value: function addTodoToUI(title, description, action, date, todoKey) {\n      this.todoBottom.innerHTML += \"\\n        <div class=\\\"todo-item mt-2\\\">\\n            <p class=\\\"todo-item-action text-capitalize\\\" id=\\\"todo-action\\\">\".concat(action, \"</p>\\n            <div class=\\\"todoTitleAndDescription\\\">\\n                <p class=\\\"todo-item-title\\\" id=\\\"todo-title\\\">\").concat(title, \"</p>\\n                <small id=\\\"todo-description\\\">\").concat(description, \"</small>\\n            </div>\\n            <p class=\\\"todo-item-date text-capitalize\\\" id=\\\"todo-date\\\">\").concat(date, \"</p>\\n            <div class=\\\"todo-item-icons\\\">\\n                <i class=\\\"far fa-trash-alt delete-todo\\\" data-key=\").concat(todoKey, \"></i>\\n                <i class=\\\"far fa-edit update-todo\\\" data-update=\").concat(todoKey, \"></i>\\n            </div>\\n        </div>\\n        \");\n    }\n  }, {\n    key: \"checkInputEmpty\",\n    value: function checkInputEmpty() {\n      if (this.inputTitle.value !== \"\" && this.inputDescription.value !== \"\" && this.selectAction.value !== \"\" && this.selectDate.value !== \"\") {\n        return true;\n      } else {\n        this.animateCSS(this.todoDetails, 'shakeX');\n        this.showAlerts(\"danger\", \"do not empty\");\n      }\n    }\n  }, {\n    key: \"clearInputs\",\n    value: function clearInputs() {\n      this.inputTitle.value = \"\";\n      this.inputDescription.value = \"\";\n    } // UI Functions End\n    // Firebase Functions \n\n  }, {\n    key: \"checkUserLogin\",\n    value: function checkUserLogin() {\n      var _this2 = this;\n\n      firebase.auth().onAuthStateChanged(function (user) {\n        //whatever user we logged in with, that user's information will come in.\n        if (user) {\n          _this2.currentUser = user.uid;\n          _this2.navbarEmail.innerHTML = \"User: \".concat(user.email);\n\n          _this2.logoutFirebase();\n\n          _this2.addTodosToFirebase();\n\n          _this2.getAllTodosFromFirebase();\n        } else {\n          window.location.href = \"register.html\";\n        }\n      });\n    } //! function to capture todo on firebase by pressing update button\n\n  }, {\n    key: \"getTodoFromFirebase\",\n    value: function getTodoFromFirebase(todoKey) {\n      var _this3 = this;\n\n      var todoRef = firebase.database().ref(\"users/\".concat(this.currentUser)).child(\"todos\").child(todoKey);\n      todoRef.once(\"value\", function (snapShot) {\n        console.log(snapShot.val());\n\n        _this3.addAndUpdateDetailsBar(snapShot.val());\n      });\n    } //! pressing the update button will display the \"todo.value\" on the firebase\n\n  }, {\n    key: \"addAndUpdateDetailsBar\",\n    value: function addAndUpdateDetailsBar(todo) {\n      this.selectAction.value = todo.action;\n      this.inputTitle.value = todo.title;\n      this.selectDate.value = todo.date;\n      this.inputDescription.value = todo.description;\n      this.todoDetails.classList.add(\"active\"); // Open the details bar\n\n      this.addTodoButton.classList.add(\"active\");\n      this.updateTodoButton.classList.remove(\"active\");\n      window.scrollTo({\n        top: 0,\n        behavior: 'smooth'\n      });\n    }\n  }, {\n    key: \"addUpdatedTodoToFirebase\",\n    value: function addUpdatedTodoToFirebase(todoKey) {\n      var _this4 = this;\n\n      var listener = function listener() {\n        firebase.database().ref(\"users/\".concat(_this4.currentUser)).child(\"todos\").child(todoKey).update(_this4.allValues()).then(function () {\n          _this4.updateTodoButton.removeEventListener(\"click\", listener);\n\n          _this4.updateTodoButton.classList.add(\"active\");\n\n          _this4.addTodoButton.classList.remove(\"active\");\n\n          _this4.clearInputs();\n\n          _this4.showAlerts(\"info\", \"todo updated!\");\n        });\n      };\n\n      this.updateTodoButton.addEventListener(\"click\", listener);\n    }\n  }, {\n    key: \"updateTodoFromFirebase\",\n    value: function updateTodoFromFirebase() {\n      var _this5 = this;\n\n      var updateTodoButtons = document.querySelectorAll(\".update-todo\");\n      updateTodoButtons.forEach(function (button) {\n        button.addEventListener(\"click\", function () {\n          var todoKey = button.dataset.update;\n\n          _this5.getTodoFromFirebase(todoKey);\n\n          _this5.addUpdatedTodoToFirebase(todoKey);\n        });\n      });\n    }\n  }, {\n    key: \"deleteTodoFromFirebase\",\n    value: function deleteTodoFromFirebase() {\n      var _this6 = this;\n\n      var deleteTodoButtons = document.querySelectorAll(\".delete-todo\");\n      deleteTodoButtons.forEach(function (button) {\n        button.addEventListener(\"click\", function () {\n          var todoKey = button.dataset.key;\n          var item = button.parentElement.parentElement;\n\n          _this6.animateCSS(item, 'backOutUp');\n\n          setTimeout(function () {\n            firebase.database().ref(\"users/\".concat(_this6.currentUser)).child(\"todos\").child(todoKey).remove();\n          }, 1000);\n        });\n      });\n    }\n  }, {\n    key: \"getAllTodosFromFirebase\",\n    value: function getAllTodosFromFirebase() {\n      var _this7 = this;\n\n      var todoRef = firebase.database().ref(\"users/\" + this.currentUser).child(\"todos\");\n      todoRef.on(\"value\", function (snapShot) {\n        _this7.clearInputs(); // This functions clear all inputs\n\n\n        _this7.todoBottom.innerHTML = \"\";\n        snapShot.forEach(function (item) {\n          var todoKey = item.key;\n\n          _this7.addTodoToUI(item.val().title, item.val().description, item.val().action, item.val().date, todoKey);\n        }); //this function should work here, because we can select the button after the html is dynamically generated\n\n        _this7.deleteTodoFromFirebase();\n\n        _this7.updateTodoFromFirebase();\n      });\n    }\n  }, {\n    key: \"addTodosToFirebase\",\n    value: function addTodosToFirebase() {\n      var _this8 = this;\n\n      this.addTodoButton.addEventListener(\"click\", function () {\n        if (_this8.checkInputEmpty()) {\n          firebase.database().ref(\"/users\").child(_this8.currentUser).child(\"todos\").push(_this8.allValues()).then(function () {\n            _this8.showAlerts(\"success\", \"todo added!\");\n          });\n        }\n      });\n    } // for firebase to-do add and to-do update operations\n\n  }, {\n    key: \"allValues\",\n    value: function allValues() {\n      return {\n        action: this.selectAction.value,\n        date: this.selectDate.value,\n        title: this.inputTitle.value,\n        description: this.inputDescription.value\n      };\n    } //when the signOut button is pressed\n\n  }, {\n    key: \"logoutFirebase\",\n    value: function logoutFirebase() {\n      this.logoutButton.addEventListener(\"click\", function () {\n        firebase.auth().signOut().then(function () {\n          window.location.href = \"login.html\";\n        })[\"catch\"](function (err) {\n          console.log(err);\n        });\n      });\n    }\n  }]);\n\n  return MainTodo;\n}();\n\n//# sourceURL=webpack:///./Src/javascript/Modules/mainTodo.js?");
