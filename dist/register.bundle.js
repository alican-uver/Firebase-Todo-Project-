...
/***/ "./src/javascript/Modules/register.js":
/*!********************************************!*\
  !*** ./src/javascript/Modules/register.js ***!
  \********************************************/
/*! no exports provided */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _scss_main_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../scss/main.scss */ \"./src/scss/main.scss\");\n/* harmony import */ var _scss_main_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_scss_main_scss__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _firebaseConfig_config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../firebaseConfig/config */ \"./src/javascript/firebaseConfig/config.js\");\n/* harmony import */ var _checkForm__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./checkForm */ \"./src/javascript/Modules/checkForm.js\");\n/* harmony import */ var _registerFirebase__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./registerFirebase */ \"./src/javascript/Modules/registerFirebase.js\");\n\n\n\n\nwindow.addEventListener(\"load\", function () {\n  new _checkForm__WEBPACK_IMPORTED_MODULE_2__[\"CheckForm\"]();\n  new _registerFirebase__WEBPACK_IMPORTED_MODULE_3__[\"RegisterFirebase\"](_firebaseConfig_config__WEBPACK_IMPORTED_MODULE_1__[\"firebaseConfig\"]);\n});\n\n//# sourceURL=webpack:///./src/javascript/Modules/register.js?");

/***/ }),

/***/ "./src/javascript/Modules/registerFirebase.js":
/*!****************************************************!*\
  !*** ./src/javascript/Modules/registerFirebase.js ***!
  \****************************************************/
/*! exports provided: RegisterFirebase */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"RegisterFirebase\", function() { return RegisterFirebase; });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar RegisterFirebase = /*#__PURE__*/function () {\n  function RegisterFirebase(config) {\n    _classCallCheck(this, RegisterFirebase);\n\n    // Firebase Config\n    this.config = firebase.initializeApp(config); // Select Elements \n\n    this.email = document.getElementById(\"email\");\n    this.password = document.getElementById(\"password\");\n    this.password2 = document.getElementById(\"password2\");\n    this.registerButton = document.getElementById(\"register-button\");\n    this.goLoginPageBtn = document.getElementById(\"go-login-page\");\n    this.init();\n  }\n\n  _createClass(RegisterFirebase, [{\n    key: \"init\",\n    value: function init() {\n      this.registerFirebase();\n    }\n  }, {\n    key: \"registerFirebase\",\n    value: function registerFirebase() {\n      var _this = this;\n\n      this.registerButton.addEventListener(\"click\", function () {\n        if (_this.password.value === _this.password2.value) {\n          firebase.auth().createUserWithEmailAndPassword(_this.email.value, _this.password.value) // if success the create account process\n          .then(function () {\n            firebase.auth().signInWithEmailAndPassword(_this.email.value, _this.password.value) // if success the login process\n            .then(function () {\n              window.location.href = \"index.html\";\n            });\n          })[\"catch\"](function (err) {\n            return console.log(err);\n          });\n        }\n      });\n    }\n  }]);\n\n  return RegisterFirebase;\n}();\n\n//# sourceURL=webpack:///./src/javascript/Modules/registerFirebase.js?");
...
/***/ 1:
/*!**************************************************!*\
  !*** multi ./src/javascript/Modules/register.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("module.exports = __webpack_require__(/*! ./src/javascript/Modules/register.js */\"./src/javascript/Modules/register.js\");\n\n\n//# sourceURL=webpack:///multi_./src/javascript/Modules/register.js?");
